...
// Minimal mobile top bar: panda + streak/goal chip + account + pinyin toggle.
export default function Dashboard({ onOpenAccount, onOpenProfile, signedIn, streak = 0, xpToday = 0, dailyGoal = 30 }) {
  return (
